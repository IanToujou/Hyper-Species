    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(args.length == 2 && (args[0].equalsIgnoreCase("accept") || args[0].equalsIgnoreCase("deny"))) {
            ...
            if(args[0].equalsIgnoreCase("accept")) {
                ...
                player.sendMessage(Component.text(Config.MESSAGE_PREFIX + " §7You invited §b" + target.getName() + "§7 to your team§8."));
                target.sendMessage(Component.text(Config.MESSAGE_PREFIX + " §7Your team join request got accepted§8."));
                ...
                player.sendMessage(Component.text(Config.MESSAGE_PREFIX + " §cYou denied §b" + target.getName() + "'s§c request§8."));
                target.sendMessage(Component.text(Config.MESSAGE_PREFIX + " §cYour team join request got denied§8."));
            }
        ...
        if(playerManager.getTeam() == null) {
            ...
            ownerMeta.displayName(Component.text("§b" + Bukkit.getOfflinePlayer(team.getOwner()).getName()));
            ownerMeta.lore(List.of(Component.text("§7Rank: §dOwner")));
