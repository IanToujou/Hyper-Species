        ...
        BukkitTask task = new BukkitRunnable() {
            ...
            public void run() {
                ...
                for(Player all : players) {
                    if(all != player && all.getWorld() == player.getWorld() && all.getLocation().distanceSquared(location) <= radiusSquared) all.addPotionEffect(new PotionEffect(PotionEffectType.CONFUSION, 10, 0, false, false, true));
                }
            }
